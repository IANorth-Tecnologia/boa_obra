                    ...
                    <div className="bg-white p-2 px-4 border-b flex justify-between items-center shrink-0 gap-3">
                        ...
                        <div className="w-1/3 flex justify-end">
                            {passoWizard < 3 ? (
                                ...
                                <button onClick={salvarRdoCompleto} disabled={loading} className="bg-green-600 text-white px-4 py-2 rounded-lg font-bold flex items-center gap-1 text-sm shadow-sm">
                                    {loading ? "..." : "Salvar"} <Save size={18}/>
                                </button>
                            )}
                        </div>
                    </div>
